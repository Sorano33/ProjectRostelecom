...
class AuthPage(BasePage):
    ...
    def auth_by_phone(self):
        self.find_element(AuthLocators.AUTH_PHONE_TAB, time=10).click()

    # Авторизация по электронной почте
    def auth_by_email(self):
        self.find_element(AuthLocators.AUTH_EMAIL_TAB, time=10).click()
    ...
    def logout(self):
        self.find_element(AuthLocators.LOGOUT_BTN, time=10).click()
